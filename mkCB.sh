...
#set to parent dir
export CBDATAROOT='/pl/active/CSUClinHeme/users/dylan/proj01_k9_bm_scrna/output/cb_input/'

outDir="../output/cb_output/"
# cmd1="cbBuild -i ./cellbrowser.conf -o ${outDir}" #use this if you have 1 subset
cmd1="cbBuild -r -i ../output/cb_input/cellbrowser.conf -o ${outDir}" #use this if you have more than 1 subset
cmd1="cbBuild -r -i ./cellbrowser.conf -o ../cb_output/" #use this if you have more than 1 subset

#generate configs:

### setting:
name="Canine-hematopoesis"
tags="10x"
organism="Canis lupus familiaris"
project="Single cell atlas"
dotSize=3

title="A single-cell RNA sequencing atlas of canine bone marrow"
