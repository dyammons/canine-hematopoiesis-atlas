...
seu.obj <- integrateData(din = "../output/s1/", dout = "../output/s2/", outName = "bm_cd34_analysis_231211_v5", runAllMethods = TRUE)

seu.obj <- readRDS("../output/s2/bm_cd34_analysis_231211_v5_integrated_S2.rds")
